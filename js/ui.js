...
function registerCalculatorButtons() {
    var newDataObjectFunctions = {
        ...
        "medfes": function () {
            return new MedFesData();
        },
        "chafes": function () {
            return new ChaFesData();
        },
        "rally": function () {
            return new RallyData();
        },
        "friendm": function () {
            return new FriendlyMatchData();
        }
    };
...
function loadCookieData() {
    var loadFunctions = {
        ...
        "scorem": ScoreMatchData.setToUi,
        "medfes": MedFesData.setToUi,
        "chafes": ChaFesData.setToUi,
        "rally": RallyData.setToUi,
        "friendm": FriendlyMatchData.setToUi
    };
...
/**
 * Listener for clicks on the region radios of the automatic timer method. Handles showing the correct elements, the
 * event progress bar, the event images and the text display of the time left in/until the event.
    ...
    if (document.cookie === "") {
        showDialog(COOKIE_POLICY + "<br><br>Do you agree with the cookie policy and " +
            ...
            function () {
                ...
                document.cookie = "cookieConsent=1; expires=" + expiryDate.toUTCString() + "; path=/llsif";
        ...
        document.cookie = key + "=" + value + "; expires=" + expiryDate.toUTCString() + "; path=/llsif";
        return true;
    }
};
...
Cookie.removeAll = function () {
    ...
    for (var i = 0; i < cookies.length; i++) {
        ...
        document.cookie = name + "=;expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/llsif";
    }
};
